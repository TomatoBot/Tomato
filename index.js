...
// var discordFuncs = require('./dJSFuncs.js'); // someday...
...
client.registry
	...
	client.on('error', m => discordDevLogSend(error));
	process.on('unhandledRejection', error => discordDevLogSend(error));
